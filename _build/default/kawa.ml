...
type instr =
  ...
  | Expr   of expr
  (*permet de declarer des variables locales*)
  | NewVar of string*typ 
...
type class_def = {
    class_name: string;
    attributes: ((string * typ) * bool) list; (*le bool indique si l'attribut est final*)
